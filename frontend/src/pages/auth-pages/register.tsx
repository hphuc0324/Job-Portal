...
function RegisterPage() {
  ...
  const handleSocialRegister = async (loginType: 'google' | 'github', role: string | null) => {
    try {
      const res = await authApi.socialLoginUrl(loginType, role);
      ...
      <div className="w-full min-h-16 max-w-screen-md  grid grid-cols-12 border-2 border-black rounded-xl ">
        <div className="col-span-12 md:col-span-6 min-h-16 px-8 ">
          ...
          <div className="mt-6">
            ...
            <RegisterForm onSubmit={handleSubmit} isLoading={isLoading} onSocialRegister={handleSocialRegister} />
